...
parser.add_argument('--katakana', action='store_true', help='Drill Katakana' )
...
listfn = hira.getAggregateList
if args.katakana:
    listfn = kata.getAggregateList

kana = listfn(args.include)
